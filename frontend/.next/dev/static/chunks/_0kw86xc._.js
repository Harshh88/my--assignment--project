...
function RegisterPage() {
    ...
    const handleRegister = async (e)=>{
        e.preventDefault();
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/auth/register", {
                name,
                email,
                password
            });
...
_s(RegisterPage, "sZqhRBCs1VxphM9j/6V0otZ4Pf4=", false, function() {
    return [
...
//# sourceMappingURL=_0kw86xc._.js.map